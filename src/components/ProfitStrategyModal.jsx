...
function TradeTimeline() {
  const steps = [
    ...
    { icon: LuClock, title: 'До открытия рынка', note: 'Входим за 10–30 минут до открытия' },
    { icon: LuBell, title: 'Открытие биржи', note: 'Приходят крупные деньги' },
    { icon: LuCheck, title: 'Выходим', note: 'Через 1–5 минут (сделка обычно закрывается по TP)' },
  ];
  return (
    ...
    <Modal open={open} onClose={onClose}>
      <div className="p-5 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            Отчёты обычно выходят, когда основная биржа ещё закрыта. В это время торгует мало участников, поэтому цена
            реагирует медленно или слишком эмоционально. Когда через 15–30 минут открывается основная сессия и приходят
            крупные деньги, цена доходит до справедливого уровня. Мы входим до этого движения и забираем его.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            Мы не гадаем, каким будет отчёт. Мы ждём, пока он выйдет, смотрим фактические данные отчёта и только потом
            входим — по факту, а не по прогнозу. Это убирает главный риск.
          </p>
          <ul className="space-y-2 mt-1">
            <Bullet>
              <span className="font-semibold text-gray-800">Когда входим:</span> за 10–30 минут до открытия биржи
              (NYSE/NASDAQ). Отчёт уже вышел, направление понятно.
            </Bullet>
            <Bullet>
            ...
            <Bullet>
              <span className="font-semibold text-gray-800">Сколько держим:</span> от 1 до 5 минут после открытия, обычно
              сделки закрываются по Тейк Профиту. Быстро вошли — быстро вышли.
            </Bullet>
          </ul>
        </div>
