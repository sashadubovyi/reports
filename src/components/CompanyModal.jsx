...
// The TradingView analysis widget needs a fully qualified EXCHANGE:TICKER
// symbol; a bare ticker can resolve to the wrong listing. Derive the prefix
// from the Finnhub profile's exchange name; companies with an explicit
// tvSymbol override (European listings) skip this entirely.
